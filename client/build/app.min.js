...
angular.module("chatApp").controller("RoomController",["$scope","socket","$location","$routeParams",function(o,e,r,n){o.message="",o.roomName=n.room,o.currUser=n.user,o.messageHistory=[],o.currUsers=[],e.emit("joinroom",{room:o.roomName}),e.on("updateusers",function(r,n,m){e.emit("users"),e.emit("rooms"),e.emit("getUserChannels"),r==o.roomName&&(o.currUsers=n)}),e.on("updatechat",function(e,r){e==o.roomName&&(o.messageHistory=r)}),o.sendmsg=function(){e.emit("sendmsg",{roomName:o.roomName,msg:o.message}),o.message=null},o.leaveRoom=function(){e.emit("partroom",o.roomName),r.path("/roomlist/"+o.currUser)},o.kickUser=function(r){e.emit("kick",{user:r,room:o.roomName},function(o){o?console.log(r+" has been kicked out!"):console.log(r+" has NOT been kicked out")})},e.on("kicked",function(e,n,m){o.roomName===e&&o.currUser===n&&r.path("/roomlist/"+o.currUser+"/")}),o.banUser=function(r){e.emit("ban",{user:r,room:o.roomName},function(e){e?console.log(r+" has been banned from "+o.roomName):console.log(r+" has NOT been banned!")})},e.on("banned",function(e,n,m){o.roomName===e&&o.currUser===n&&r.path("/roomlist/"+o.currUser+"/")}),o.logOut=function(){e.emit("disconnectNow"),r.path("/login")}}]);
