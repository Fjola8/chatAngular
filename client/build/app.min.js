...
angular.module("chatApp").controller("RoomController",["$scope","socket","$location","$routeParams",function(o,e,m,r){o.message="",o.roomName=r.room,o.currUser=r.user,o.messageHistory=[],o.currUsers=[],e.emit("joinroom",{room:o.roomName}),e.on("updateusers",function(m,r,s){e.emit("users"),e.emit("rooms"),e.emit("getUserChannels"),m==o.roomName&&(o.currUsers=r)}),e.on("updatechat",function(e,m){e==o.roomName&&(o.messageHistory=m)}),o.sendmsg=function(){e.emit("sendmsg",{roomName:o.roomName,msg:o.message}),o.message=null},o.leaveRoom=function(){e.emit("partroom",o.roomName),m.path("/roomlist/"+o.currUser)},o.logOut=function(){e.emit("disconnectNow"),m.path("/login")}}]);
